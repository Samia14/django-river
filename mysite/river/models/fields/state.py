...
class classproperty(object):
    def __init__(self, getter):
        print("in getter for initializer",getter)
        self.getter = getter

    def __get__(self, instance, owner):
        print("getter class property",self.__dict__)
...
def _on_workflow_object_saved(sender, instance, created, *args, **kwargs):
    print("i am here", instance.river.all(instance.__class__))
    # print("why like why",instance.river.all(instance).__dict__)
