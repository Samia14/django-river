...
from river.models.workflow import Workflow,NewModel
...
class WorkflowForm(forms.ModelForm):
    ...
    def clean_workflow(self):
        print("clean work floww working",self.cleaned_data.get('workflow').split(" "))
        print("clean data dict",self.cleaned_data)
